...
class PaginaSugerencia extends StatefulWidget {
  const PaginaSugerencia({super.key});
  static String id = 'pagina_sugerencia';

  @override
  PaginaSugerenciaState createState() => PaginaSugerenciaState();
}

class PaginaSugerenciaState extends State<PaginaSugerencia> {
  ...
  Widget _buildCategoryIcons() {
    return Row(
      ...
      children: [
        _buildCategoryIcon(Icons.comment, 'SUGERENCIA'),
      ],
    );
  }
